...
if ($func == "product"){
    ...
    $sql = "SELECT `product_code`, `product_img`, `product_name`, `manufacturer`, `product_type`, `color`, `item_price`, `critical_amt`, `rop_min`, `ro_categ`, `product_img`, `description`, `supplier_id`, w.id AS warranty_code FROM `products` INNER JOIN warranty w ON products.warranty_code = w.id WHERE `product_code` = '$edit_id'";
