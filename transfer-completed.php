            ...
            <form action="#">
                <div class="extra-details">
                    ...
                    <div class="input-box">
                        ...
                        <input type = "text" id="warehouse_code-c" class = "warehouse_code required"autocomplete="off" style = "width:100%" disabled ="disabled" >
                    </div>
                ...
                <div class="extra-details">
                    <div class="input-box">
                        ...
                        <input type = "text" id="warehouse_dest-c" class="warehouse_dest required" autocomplete="off" style = "width:100%" disabled ="disabled" >
                    </div>
                    <div class="input-box">
    ...
    function view(id){
        ...
        $.ajax({
            ...
            success: function(data) {
                $('#warehouse_code-c').val(data.warehouse_source);
                $('#transfer_id-in').val(data.transfer_id);
                $('#transaction_date').val(data.request_date);
                $('#warehouse_dest-c').val(data.warehouse_dest);
