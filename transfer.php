        ...
        <div class="content">
            <form action="#">
                <div class="extra-details">
                    Accept selected transfer requests? This action is not reversible.
                </div>
                <div class="action-button">
                    <button formnovalidate="formnovalidate" class = "btn-cancel">Cancel</button>
                    <input type="submit" id = "submit-confirm" value="Accept"/>
                </div>
            </form>
        </div>
    </div>
...
<!-- Modal content -->
    <div class="input-container">
        <div class="title-box"><div class="title"><span> Decline </span> Transfer Request</div><div class="close-div"><a href="#" class = "link-2 close"></a></button></div></div>
        <div class="content">
            <form action="#">
                <div class="extra-details">
                    Decline selected transfer requests? This action is not reversible.
                </div>
                <div class="action-button">
                    <button formnovalidate="formnovalidate" class = "btn-cancel">Cancel</button>
                    <input type="submit" id = "delete-confirm" value="Decline"/>
                </div>
            </form>
        </div>
    </div>
...
<div id = "view" class = "modal">
    <div class="input-container">
    <div class="title-box"><div class="title">Transfer Inventory</div><div class="close-div"><a href="#" class = "link-2 close"></a></button></div></div>
        <div class="content">
            <form action="#">
                <div class="extra-details">
                    ...
                    <div class="input-box">
                        ...
                        <input type = "text" id="warehouse_code-v" class = "warehouse_code required"autocomplete="off" style = "width:100%" disabled ="disabled" >
                    </div>
                ...
                <div class="extra-details">
                    <div class="input-box">
                        ...
                        <input type = "text" id="warehouse_dest-v" class="warehouse_dest required" autocomplete="off" style = "width:100%" disabled ="disabled" >
                    </div>
                    <div class="input-box">
...
$(document).ready(function(){
    ...
    function view(id){
        ...
        $.ajax({
            ...
            dataType:"json",
            success: function(data) {
                $('#warehouse_code-v').val(data.warehouse_source);
                $('#transfer_id-in').val(data.transfer_id);
                $('#transaction_date').val(data.request_date);
                $('#warehouse_dest-v').val(data.warehouse_dest);
